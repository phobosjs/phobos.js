...
class Phobos {
  ...
  constructor(options) {
    ...
    this.serverPlugins = require('../config/restify-plugins');
  ...
  //
  initPlugins() {
    for (let plugin of this.serverPlugins) {
      if (typeof plugin === 'string') {
        this.server.use(restify[plugin]());
      } else if (typeof plugin === 'function') {
        this.server.use(plugin());
      } else {
        this.server.use(restify[plugin.name](plugin.options));
      }
    }
