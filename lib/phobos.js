...
console.log("Phobos, mongoose version:", mongoose.version);
class Phobos {
  constructor(options) {
    this._options = {
      port: 9292,
  ...
  /* 
  TODO: currently we monkey-patch this fn in test setup files.
  This method is needed for testing purposes, it will destroy the Phobos instance,
  preventing memory leaks between tests.
  */
  async destroy() {
